...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener, JoystickView.JoystickListener{
...
//    }
    ...
    public void onJoystickMoved(float xPercent, float yPercent, int id) {
        ...
        joyStick_X = xPercent;
        joyStick_Y = yPercent;
        etSend.setText("xpercent = " + joyStick_X + ", " + " ypercent = " + joyStick_Y);
